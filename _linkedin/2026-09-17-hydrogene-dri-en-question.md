---
title: "L'hydrogène dans le fer préréduit européen, et ce qui avance à sa place"
date: 2026-09-17
date_affichee: "17 septembre 2026"
lang: fr
ref: linkedin-hydrogene-dri-en-question
key: linkedin-hydrogene-dri-en-question
permalink: /linkedin/2026-09-17-hydrogene-dri-en-question.html
...
<!-- Page engendrée par Communication/Linkedin/publier.py — ne pas éditer ici :
     modifier meta.yml / texte_fr.md dans Communication/Linkedin/2026-09-17_hydrogene-dri-en-question/ -->

<p class="linkedin-meta"><a href="https://www.linkedin.com/posts/activity-7506236956503232512-juYk" target="_blank" rel="noopener"><i class="fab fa-linkedin"></i> Voir le post et ses commentaires sur LinkedIn</a> · publié le 17 septembre 2026 · <a href="/linkedin.html">tous les posts</a></p>

<figure class="linkedin-figure">
<a href="{{ site.baseurl }}/assets/linkedin/2026-09-17-hydrogene-dri-en-question/figure_chaine_fr.png" target="_blank"><img src="{{ site.baseurl }}/assets/linkedin/2026-09-17-hydrogene-dri-en-question/figure_chaine_fr.png" alt="L'hydrogène dans le fer préréduit européen, et ce qui avance à sa place" style="max-width:100%;height:auto;"></a>
<figcaption><small>Les cinq premiers reels de la série « acier », dans l'ordre du récit — de la fabrication à l'électrolyse. Ce n'est pas une figure de données : c'est la bande d'accueil de la chaîne, remontée depuis les couvertures elles-mêmes (celles qu'engendre le script des couvertures de la chaîne) et non capturée à l'écran, pour qu'elle se refasse à l'identique. Millésime septembre 2026.</small></figcaption>
</figure>

> Les sources chiffrées de ce post sont dans `sources.md` du dossier : c'est là que se trouvent les valeurs, leurs unités et leurs millésimes, et non sur l'image.
...
Le script [build_figure.py]({{ site.baseurl }}/assets/linkedin/2026-09-17-hydrogene-dri-en-question/build_figure.py) produit la figure à lui seul.
...
Tous les fichiers de ce post (figures, données, scripts) sont dans le dossier [2026-09-17-hydrogene-dri-en-question](https://git.persee.minesparis.psl.eu/energy-alternatives/linkedinposts/-/tree/main/posts/2026-09-17-hydrogene-dri-en-question) du dépôt public.
